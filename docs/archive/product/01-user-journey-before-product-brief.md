# Archived: BayarAman User Journey Before Product Brief

> Archived on 2026-07-16. This draft was created before the workflow had a `00 Product Brief` stage. Keep it only as reference material; it is not an approved product source.
...
These should become traceable requirements in `02-user-requirements.md` and detailed QA cases in `03-qa-scenarios.md`.
